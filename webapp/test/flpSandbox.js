		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#healthtrackerui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"healthtrackerui-display": {
								"semanticObject": "healthtrackerui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=healthtrackerui",
									"url": sap.ui.require.toUrl("healthtrackerui")
								}
							}
						}
					}
